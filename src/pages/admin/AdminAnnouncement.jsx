  ...
  return (
    <>
      ...
      >
        ...
        >
          <section className="flex w-full justify-between items-center">
            <h1 className="flex flex-col font-semibold text-4xl">
              <span className="text-base">Hola!</span> Announcements
            </h1>
          </section>
        ...
        <AnimatePresence>
          {visible ? 
            <AnimatedSection key="Table" className="flex flex-col w-full md:max-w-2xl xl:max-w-7xl h-[670px] bg-gray-50 border rounded-4xl overflow-hidden">
